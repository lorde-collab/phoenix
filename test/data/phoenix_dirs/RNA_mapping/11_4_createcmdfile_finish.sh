...
do
  ...
  # Write commands
  echo fixmateinfo_merge_markdup_index.sh /research/rgs01/resgen/prod/tartan/runs/RNA_mapping/nRZ0IX0M/intmd/$sample/finish/$rootname.bam $refdir/bam/refined*.bam -- $refdir/bam/unrefined*.bam
done > /research/rgs01/scratch/tartan_prod/RdUXkN3rhZ/workspace/cmds-11.sh
