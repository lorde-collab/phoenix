...
do
  # Write commands
  make_script_ubam_to_fastq.sh /research/rgs01/resgen/prod/tartan/runs/RNA_mapping/nRZ0IX0M/intmd/$sample/ubam /research/rgs01/resgen/prod/tartan/runs/RNA_mapping/nRZ0IX0M/intmd/$sample/fastq
done > /research/rgs01/scratch/tartan_prod/RdUXkN3rhZ/workspace/cmds-00.sh
