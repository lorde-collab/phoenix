...
do
  ...
  if ! qcquiet.sh /research/rgs01/scratch/tartan_prod/RdUXkN3rhZ/workspace/files-08-merge/failed_qc/$sample qc_sim4_refinements.sh $refdir/refinement $refdir/fasta-sized
  then anyfail=yes
  fi
