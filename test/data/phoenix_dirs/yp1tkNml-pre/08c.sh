...
do
  ...
  if ! qcquiet.sh /research/rgs01/scratch/tartan_prod/t_7OHnDQHK/workspace/files-08-merge/failed_qc/$sample qc_sim4_refinements.sh $refdir/refinement $refdir/fasta-sized
  then anyfail=yes
  fi
